...
public class SlidingTabsColorsFragment extends Fragment {
    ...
    static class SamplePagerItem {
        ...
        SamplePagerItem(String title, int indicatorColor, int dividerColor,boolean visibility) {
        ...
        Fragment createFragment() {
            return ContentFragment.newInstance(mTitle, mIndicatorColor, mDividerColor,vis);
        }
